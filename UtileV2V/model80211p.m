function [PDR,deltaSEN,deltaRXB,deltaPRO,deltaCOL,CBR] = model80211p(beta,lambda,Pt,B,Rd,distance);
...
%     fprintf('  Rd     = %d Mbps \n', Rd/1e6)
    ...
    deltaSEN = zeros(1,length(distance_tx_to_rx));
    deltaRXB = zeros(1,length(distance_tx_to_rx));
    deltaPRO = zeros(1,length(distance_tx_to_rx));
    deltaCOL = zeros(1,length(distance_tx_to_rx));
    PL_Tx_Rx = zeros(1,length(distance_tx_to_rx));
    deltaRXB_pre = zeros(1,length(distance_tx_to_rx));
    deltaCOL_pre = zeros(1,length(distance_tx_to_rx));
    std_dev_Tx_Rx = zeros(1,length(distance_tx_to_rx));
    ...
    for d=1:length(distance_tx_to_rx)
        ...
        p_int = zeros(1,length(distance_int_to_rx));
         pSINR = zeros(1,length(distance_int_to_rx));
         p_DET_i_Rx = zeros(1,length(distance_int_to_rx));
         p_DET_i_Tx = zeros(1,length(distance_int_to_rx));
         p_sim_CT = zeros(1,length(distance_int_to_rx));
         p_RXB_CT = zeros(1,length(distance_int_to_rx));
         p_RXB_HT = zeros(1,length(distance_int_to_rx));
         p_COL_CT = zeros(1,length(distance_int_to_rx));
         p_sim_HT = zeros(1,length(distance_int_to_rx));
         p_COL_HT = zeros(1,length(distance_int_to_rx));
